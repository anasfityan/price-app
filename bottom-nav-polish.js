...
(function(){
  ...
  const ICONS={
    ...
    'bn-rates':'<path d="M7 7h10"/><path d="m14 4 3 3-3 3"/><path d="M17 17H7"/><path d="m10 14-3 3 3 3"/><circle cx="12" cy="12" r="9"/>',
  ...
  function upgrade(){
    Object.keys(ICONS).forEach(function(id){
      ...
      if(!svg||svg.dataset.gacelaIcon==='1') return;
      svg.setAttribute('viewBox','0 0 24 24');
      svg.innerHTML=ICONS[id];
      svg.dataset.gacelaIcon='1';
    });
  }
